...
2. Move the contents of `Project Templates` in the repository into the `/Applications/Xcode.app/Contents/Developer/Library/Xcode/Templates/Project Templates` directory. You may have to create the `Templates/Project Templates` directories.
